...
| 指尖漂移 | 单键漂移竞速 | [`/drift/`](drift/) |
| 特技摩托 | 横版物理特技 | [`/moto/`](moto/) |
| 节奏冲刺 | 音乐节奏跑酷 | [`/dash/`](dash/) |
| 黄金矿工 | 摆钩抓金经典 | [`/miner/`](miner/) |
| 深渊百层 | 下落闯关经典 | [`/down100/`](down100/) |
| 坦克大战 | 经典坦克双人 | [`/tanks/`](tanks/) |
| 魔塔 | 数值策略爬塔 | [`/mota/`](mota/) |
| 果蔬连连看 | 连线消除经典 | [`/link/`](link/) |
| 轨道弹珠 | 祖玛类消除 | [`/zuma/`](zuma/) |
| 整蛊关卡 | 恶搞平台跳跃 | [`/devil/`](devil/) |
| 股市骑士 | 真实股票 K 线骑行 | [`/stonk/`](stonk/) |
